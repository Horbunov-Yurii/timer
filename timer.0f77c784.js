...
const id = setInterval(()=>{
    ...
    if (time === 30) (0, _core.alert)({
        text: "\u0427\u0430\u0441 \u0432\u0438\u0439\u0434\u0435 \u0447\u0435\u0440\u0435\u0437 30 \u0441\u0435\u043A\u0443\u043D\u0434",
        delay: 1000
    });
    else if (time === 0) {
        (0, _core.alert)("\u0427\u0430\u0441 \u0432\u0438\u0439\u0448\u043E\u0432");
        console.log("\u0412\u0438\u043A\u043B\u0438\u043A \u0444\u0443\u043D\u043A\u0446\u0456\u0457 " + time);
        clearInterval(id);
    }
}, 1000);

},{"@pnotify/core":"fay4s","@pnotify/mobile":"5RXYV","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/mobile/dist/PNotifyMobile.css":"iv3sV","@pnotify/core/dist/BrightTheme.css":"grIyt"}],"fay4s":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"c4y47":[function() {},{}],"iv3sV":[function() {},{}],"grIyt":[function() {},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequireb9d2", {})
